...
export default function NotFound() {
    return (
        <>
            <div className=" -my-30 min-h-screen dark:bg-gray-900 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
                <div className="max-w-md w-full space-y- text-center">
                    <div className="mb-8">
                    ...
                    <div className="mt-8">
                        <Link to="/home" className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-secondry-color  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
